...
def Test_global():
    for x in range(len(num)):
        test_data_full = f'test_data_full{num[x]}.csv'
        total_path = os.path.join(path, test_data_full)
        csv_times = f'Resultados/csv_times{num[x]}.csv'
...
def Test_search():
    for x in range(len(num)):
        ...
        csv_time_search = f'Resultados/csv_time_search{num[x]}.csv'
...
def Test_search_range():
    for x in range(len(num)):
        ...
        print (f"Generando datos de prueba para {num[x]} registros...")
        EL_indice = MEGA_SUPER_HIPER_MASTER_INDICE(name_key = "timestamp", table_format = table_format, x = x)
        csv_time_search = f'Resultados/csv_time_search_range{num[x]}.csv'
...
def Test_insert():
    for x in range(len(num)):
        ...
        print (f"Generando datos de prueba para {num[x]} registros...")
        EL_indice = MEGA_SUPER_HIPER_MASTER_INDICE(name_key = "timestamp", table_format = table_format, x = x)
        csv_time_search = f'Resultados/csv_time_insert{num[x]}.csv'
